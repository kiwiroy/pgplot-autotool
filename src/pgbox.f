...
C
      ...
      XOPTA = INDEX(OPT,'A').NE.0 .AND. BOXRANGE(YBLC,0.0,YTRC)
      ...
      YOPTA = INDEX(OPT,'A').NE.0 .AND. BOXRANGE(XBLC,0.0,XTRC)
...
C
      ...
      CONTAINS
      LOGICAL FUNCTION BOXRANGE(A, B, C)
        REAL, INTENT(IN) :: A, B, C
        BOXRANGE = (A.LT.B .AND. B.LT.C) .OR. (C.LT.B .AND. B.LT.A)
      END FUNCTION BOXRANGE

      LOGICAL FUNCTION IRANGE(A, B, C)
        REAL, INTENT(IN) :: A, B, C
        IRANGE = (A.LE.B .AND. B.LE.C) .OR. (C.LE.B .AND. B.LE.A)
      END FUNCTION IRANGE
